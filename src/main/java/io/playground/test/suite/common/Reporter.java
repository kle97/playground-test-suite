...
public class Reporter {
    ...
    public static void startReport() {
        ...
        String reportFilePath = Constant.REPORT_PATH + filePath;
        try {
            Files.createDirectories(Paths.get(Constant.REPORT_PATH));
            Files.createDirectories(Paths.get(Constant.SCREENSHOT_PATH));
        } catch (IOException e) {
